                    ...
                    <div onClick={() => handleDetailProduct(data.id)} className="product-main cursor-pointer block">
                            ...
                            <div className="product-img w-full h-full aspect-[3/4]">
                                {activeColor ? (
                                    <div
                                        ...
                                        style={{
                                            backgroundColor: data.variation.find(item => item.color === activeColor)?.colorCode || '#000000',
                                        }}
                                    >
                                        {/* Chỉ hiển thị hình tròn màu, không có text */}
                                        <div className="w-3/4 h-3/4 rounded-full" style={{ backgroundColor: data.variation.find(item => item.color === activeColor)?.colorCode || '#000000' }} />
                                    </div>
                                ) : (
                        ...
                        <div className="product-infor mt-4 lg:mb-7">
                            ...
                            {(data.variation || []).length > 0 && (
                                <div className="list-color py-2 max-md:hidden flex items-center gap-3 flex-wrap duration-500">
                                    {(data.variation || []).map((item, index) => (
                                        ...
                                        >
                                            {/* Bỏ tag-action để chỉ hiển thị hình tròn màu */}
                                        </div>
                                    ))}
                                </div>
                            )}
                            <div className="product-price-block flex items-center gap-2 flex-wrap mt-1 duration-300 relative z-[1]">
                                ...
                                {percentSale > 0 && (
                                    <>
                                        <div className="product-origin-price caption1 text-secondary2"><del>${data.originPrice}</del></div>
