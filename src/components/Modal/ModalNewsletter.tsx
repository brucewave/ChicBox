                ...
                >
                    <div className="main-content flex rounded-[20px] overflow-hidden w-full">
                        <div
                            ...
                            <div className="text-xs font-semibold uppercase text-center">Ưu đãi đặc biệt</div>
                            <div
                                className="lg:text-[70px] text-4xl lg:leading-[78px] leading-[42px] font-bold uppercase text-center">
                                Siêu ưu đãi<br />Thứ Sáu Đen</div>
                            <div className="text-button-uppercase text-center">Khách hàng mới giảm ngay <span
                                className="text-red">30%</span>
                                với mã</div>
                            <div className="text-button-uppercase text-red bg-white py-2 px-4 rounded-lg">GET20off</div>
                            <div className="button-main w-fit bg-black text-white hover:bg-white uppercase">Sao chép mã khuyến mãi
                            </div>
                        </div>
                        <div className="right lg:w-1/2 sm:w-3/5 w-full bg-white sm:pt-10 sm:pl-10 max-sm:p-6 relative">
                            ...
                            <div className="heading5 pb-5">Có thể bạn sẽ thích</div>
                                            ...
                                            >
                                                ...
                                                <div className=''>
                                                    ...
                                                    <div className="flex items-center gap-2 mt-2">
                                                        <div className="product-price text-title">{Math.round(item.price).toLocaleString('vi-VN')} VNĐ</div>
                                                        <div className="product-origin-price text-title text-secondary2">
                                                            <del>{Math.round(item.originPrice).toLocaleString('vi-VN')} VNĐ</del>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
